...
Ho re-ingegnerizzato le parti del codice in cui venivano definite alcune variabili statiche (tipo `USER_AGENT`) in modo da spostare queste variabili in `config.yml`.
