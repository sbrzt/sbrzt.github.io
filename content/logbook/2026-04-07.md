...
***soluzione: creare nuova implementazione di situation qui dentro e riutilizzare situation; sentire vale prima di farlo***
...
* Che facciamo con [FOCO](http://www.essepuntato.it/2013/03/cito-functions)?
    - potremmo liberarcene ma ci risentiamo
...
* Non posso gestire issues: è normale?
    - da attivare permessi per ogni repo
...
- [x] La documentazione è rotta? http://purl.org/spar/bido
...
- [x] https://github.com/SPAROntologies/fr/issues/1 (RatingConcept namespace): già fatto?
