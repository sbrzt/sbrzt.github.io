...
Sto provando ad utilizzare l'API di Meta. Per ora sto incontrando problemi di tempi troppo lunghi. Ho prima provato a gestire i DOI in batch, ma è servito a poco. Proverò ad utilizzare `ThreadPoolExecutor`.
